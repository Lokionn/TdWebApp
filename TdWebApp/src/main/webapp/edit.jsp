	...
	<main class="login-form">
		<div class="topnav">
			<a class="active" href="index2">Home</a> <a href="add">Ajouter User</a> <a
				...
				Employee</a> <a href="liste2">Liste Employees</a>
		...
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
						<div class="card-header">Modifier Hello ${user.firstname} <span style="color:red;font-size: 12px">${error}</span></div>
						<div class="card-body">
							<form action="update?email2=${user.email}" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="password" id="password2" class="form-control"
											name="password2" required value="${user.password}">
									</div>
