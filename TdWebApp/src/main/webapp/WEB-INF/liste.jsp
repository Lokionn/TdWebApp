...
<body>
	...
	<br/>
	<div class="textco"> Voici les données de TOUT LE MONDE, utilisez les avec sagesse. </div>
	<br/>
					...
					<c:choose>
						<c:when test="${us.userId > 0}">
							<tr class="rowhovered">
								...
								<td>${us.lastname }</td>
								<td>${us.datecrea }</td>
								<td><a class="active" href="update?email=${us.email}"><i
										class="fa-regular fa-pen-to-square"></i></a></td>
								<td><a class="active" href="delete?email=${us.email}"
